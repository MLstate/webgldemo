...
##register to_list : glMatrix -> opa[ list(float) ]
##args(src)
...
##register create : -> glMatrix
##args()
{ return mat4.create(); }

##register perspective : float, float, float, float, glMatrix -> void
##args(fovy, aspect, near, far, dest)
{ mat4.perspective(fovy, aspect, near, far, dest); }

##register identity : glMatrix -> void
##args(dest)
{ mat4.identity(dest); }
...
##register translate : glMatrix, vec3.private, glMatrix -> void
##args(mat, vec, dest)
{ mat4.translate(mat, vec, dest); }

##register str : glMatrix -> string
##args(mat)
{ return mat4.str(mat); }

##register lookAt : vec3.private, vec3.private, vec3.private, glMatrix -> void
##args(eye, center, up, dest)
{ return mat4.lookAt(eye, center, up, dest); }

##register multiply : glMatrix, glMatrix, glMatrix -> void
##args(mat, mat2, dest)
{ return mat4.multiply(mat, mat2, dest); }

##extern-type mat3

##register toInverseMat3 : glMatrix, mat3 -> void
##args(mat, dest)
