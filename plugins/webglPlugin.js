...
##register truc_fs : Webgl.Context.private -> Webgl.WebGLShader
##args(gl) 
{
      var str = "void main(void) { gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0); }";
      var shader;
...
##register truc_vs : Webgl.Context.private -> Webgl.WebGLShader
##args(gl)
{
      var str = "attribute vec3 aVertexPosition; uniform mat4 uMVMatrix; uniform mat4 uPMatrix; void main(void) { gl_Position = uPMatrix * uMVMatrix * vec4(aVertexPosition, 1.0); }";
      var shader;
